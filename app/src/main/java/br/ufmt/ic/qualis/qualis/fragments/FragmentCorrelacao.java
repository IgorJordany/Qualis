...
public class FragmentCorrelacao extends Fragment {
    ArrayList<String> correlacs=new ArrayList<>();
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        adapter = new ArrayAdapter<> (getActivity(), android.R.layout.simple_list_item_1,correlacs);
    ...
    public void fillData() throws ExecutionException, InterruptedException {
        ...
        int i = 0;
        while ( i < aux.size()){
            correlacs.add(aux.get(i).getIssn()+" | "+ aux.get(i).getPeriodico() +" | "+ aux.get(i).getExtratocomp() +" | "+ aux.get(i).getExtrato() +" | "+ aux.get(i).getArea());
            i = i + 1;
        }
    }
}
